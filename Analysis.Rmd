...
#load SIMS data
sims <- fread("Data/Otolith_data_anadromous_2021_clean_core_with_distance_um.csv")#interchange anadromous 2021, with other otolith data files
...
fwrite(pike_d18O, "Data/2021_anadromous_data_clean.csv") #Change name according to which otolith data was loaded
```
...
ggsave("Figures/OH-exploratory-figure.pdf", d18O, width = 15, height = 10, units = "cm", dpi = 600, bg = "white")
```
...
ggsave("Figures/raw_vs_correction.pdf", raw_vs_cor, width = 15, height = 12, units = "cm", dpi = 600, bg = "white")
```
...
ggsave("Figures/raw-vs-corrected_ind.pdf", width = 15, height = 30, units = "cm", dpi = 600, bg = "white")
```
...
pdf("Figures/Yearly-signal-d18O_adapted.pdf", width = 10, height = 15)
